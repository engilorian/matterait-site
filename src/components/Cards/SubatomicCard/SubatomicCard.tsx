  ...
  return (
    <div className={`w-full aspect-square ${className}`}>
      <motion.div
        ...
        className="relative flex flex-col items-center justify-center rounded-lg border-4 border-black w-full aspect-square p-3 text-center bg-white overflow-hidden"
      >
        ...
        <div className="flex flex-col items-center">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-main font-extrabold">
              {symbol}
            </h1>
          </div>
        ...
        <motion.div
          ...
          className={`absolute inset-0 flex flex-col items-center justify-center p-6 md:p-8 ${particleTypeClass} text-white z-20`}
        >
